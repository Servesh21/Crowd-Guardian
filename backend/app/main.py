...
from app.services.map_processing import calculate_area
from objectdetection import objectdetect
from app.services.map_processing import get_location_coordinates, get_place_polygon, calculate_area_from_polygon
